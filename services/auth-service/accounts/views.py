...
from .serializers import LoginSerializer, RegisterSerializer, UserAuthResponseSerializer, UserDetailSerializer
...
class RegisterView(APIView):
    ...
    def post(self, request):
        ...
        publish_event(
            "UserRegistered",
            {"userId": str(user.id), "email": user.email, "fullName": user.full_name, "role": user.role},
        )
...
class AdminUserStatusView(APIView):
    ...
    def patch(self, request, user_id):
        ...
        AuditLog.objects.create(
            ...
            metadata={"target": str(user_id), "status": new_status},
        )
        return Response(UserDetailSerializer(user).data)
